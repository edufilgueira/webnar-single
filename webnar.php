...
<meta property="og:title" content="Saúde Financeira para todas as Pessoas que gostam de cuidar de gente." />
...
{
    window.location.href = "http://localhost/omnilife/_src/api.php/teste/opa";
}
</script>
<body onunload="return ConfirmExit()">
							...
							success: function (obj) {
								...
								if (obj != null) {
									...
									$.each(data, function (i, d) {
										novaEventoString = dataAtualFormatada() + " " + d;
										novaEvento = new Date(novaEventoString);

										if((dataAtual < novaEvento) && (contador <= 2))
										{
											$('<option>').val(d).text(d).appendTo(selectbox);
											contador +=1;
										}								
									});
									if(contador == 0) document.getElementById('reauth-msg').style.display = 'block';
								}
							}
						});
					}
				...
				function participantesonline(datadia,agendaselect){
					...
					$.ajax({
						...
						success: function (data) {
							...
							var objFalse = exibirParticipantesRand();
							qtdFalse = objFalse.length;
							qtdTotal =  parseInt(qtdTrue) +  parseInt(qtdFalse);
							$('#usuariospresenes').html("");
							
							for(i=0; i < objFalse.length; i++){
								addparticipantes(objFalse[i].nome);
							}
			   ...
			   <div class="container" style="width: 100%;">
					<div class="card card-container">
						...
						<form class="form-signin">
							...
							<span id="reauth-msg" class="reauth-msg">OBS: Encerramos as atividades. Você pode voltar no próximo dia útio.</span>
						</form>
					</div>
				</div>
			</div>
		...
		<div class="one-column column cols" id="le_body_row_9_col_1">
			...
			<div class="element-container cf" data-style="" id="le_body_row_9_col_1_el_2">
                ...
                <div class="fixed-width">
                    ...
                    <p class="footer-copyright">Copyright 2018 - Saúde e Vida - All Rights Reserved. <br><a href="privacidade.html">POLITICA DE PRIVACIDADE</a></p>
            </div>
